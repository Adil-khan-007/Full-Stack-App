...
function Signup(props) {
    ...
    const handleSubmit = (e)=>{
        e.preventDefault();
         axios.post("http://localhost:3004/auth/signup",form).then((res)=> console.log(res))
    ...
    return (
        <div style={{boxShadow:"0 0 10px black",padding:"10px 20px 20px 30px",width:"25%",margin:" 50px auto"}}>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" placeholder='Enter your age' onChange={handleChange} name="age"/><br></br>
